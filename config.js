...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "Zaynix-MD=jZhQxRRT#zrZfTghTjsdcB6_rS7GGJWJpSM7JQnPJ01yw6gkqKrQ", // Your session ID
  ...
  // --- Bot Identity ---
  BOT_NAME: process.env.BOT_NAME || "Zaynix-MD", // Bot name show in menus 
